...
export const ContactPage: React.FC = () => {
    ...
    return (
        <div className="min-h-[100svh] bg-zinc-950 text-zinc-100 relative overflow-x-clip selection:bg-orange-500/30">
            ...
            <div className="fixed top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/3 w-[500px] h-[350px] bg-orange-500/[0.03] blur-[150px] rounded-full pointer-events-none z-0"></div>
            ...
            {/* Content */}
            <main className="relative z-10 pt-24 pb-24 px-6 flex flex-col justify-center min-h-[calc(100vh-160px)]">
