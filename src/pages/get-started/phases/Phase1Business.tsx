...
export const Phase1Business: React.FC<{
    data: LeadData;
    ...
    data, update, toggleArrayItem, searchQuery, handleSearchInput,
    selectedPlace, selectPlace, clearPlace, predictions,
    showPredictions, isSearching, searchRef,
    showManualEntry, setShowManualEntry, setShowPredictions,
}) => {
        ...
        <div className="space-y-6">
            ...
            <AnimatePresence>
                {allServices.length > 0 && (
                    ...
                    >
                        <label className={labelClass}>
                            Services <span className="text-zinc-600">(auto-populated)</span>
                        </label>
