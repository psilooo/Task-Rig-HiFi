    ...
    return (
        <div className="min-h-screen bg-zinc-950 text-zinc-100 relative overflow-x-clip selection:bg-orange-500/30">
            ...
            <div className="border-y-2 border-zinc-800 relative z-10 bg-zinc-950 overflow-hidden">
                ...
                {(() => {
                    const integrations = [
                        'Twilio', 'Stripe', 'Google Calendar', 'QuickBooks', 'Mailgun',
                        'Google My Business', 'Facebook', 'Instagram', 'Slack', 'Zapier',
                        'Google Sheets', 'Calendly', 'Housecall Pro', 'ServiceTitan',
                        'Jobber', 'Square', 'Podium', 'Yext', 'CallRail', 'Salesforce',
                        'HubSpot', 'Shopify', 'WordPress', 'WhatsApp', 'Google Ads',
                        'Facebook Ads', 'TikTok Ads', 'Outlook', 'Zoom', 'Google Analytics',
                    ];
                    return (
                        <div className="relative py-5 md:py-6">
                            {/* Left fade */}
                            <div className="absolute top-0 left-0 bottom-0 w-20 md:w-32 bg-gradient-to-r from-zinc-950 to-transparent z-10 pointer-events-none" />
                            {/* Right fade */}
                            <div className="absolute top-0 right-0 bottom-0 w-20 md:w-32 bg-gradient-to-l from-zinc-950 to-transparent z-10 pointer-events-none" />

                            <div className="marquee-track">
                                <div className="marquee-content">
                                    {[...integrations, ...integrations].map((name, i) => (
                                        <div key={i} className="flex items-center gap-3 px-5 md:px-6 flex-shrink-0">
                                            <div className="w-1.5 h-1.5 rounded-full bg-orange-500/40 flex-shrink-0" />
                                            <span className="font-mono text-[11px] md:text-xs text-zinc-400 uppercase tracking-[0.15em] whitespace-nowrap">{name}</span>
                                        </div>
                                    ))}
                                </div>
                            </div>
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="mb-10 md:mb-14">
                        <ScrollReveal>
                            ...
                            <h2 className="font-heading font-bold text-3xl md:text-4xl lg:text-5xl text-white uppercase tracking-tight leading-[0.95]">
            ...
            <div className="relative z-10 flex flex-col items-center -my-4 md:-my-8">
                <div className="w-px h-10 md:h-16 bg-gradient-to-b from-orange-500/30 to-orange-500/5" />
                <div className="w-2 h-2 rounded-full bg-orange-500/40 shadow-[0_0_12px_rgba(255,106,21,0.3)]" />
                <div className="w-px h-10 md:h-16 bg-gradient-to-b from-orange-500/5 to-transparent" />
            </div>
            ...
            ════════════════════════════════════════════════════════════════ */}
            <section className="py-16 md:py-24 px-4 md:px-6 relative z-10" ref={chatRef}>
            ...
            ════════════════════════════════════════════════════════════════ */}
            <section className="py-16 md:py-24 px-4 md:px-6 relative z-10 overflow-clip">
            ...
            ════════════════════════════════════════════════════════════════ */}
            <section className="py-16 md:py-24 px-4 md:px-6 relative z-10 w-full max-w-7xl mx-auto flex flex-col items-center">
            ...
            ════════════════════════════════════════════════════════════════ */}
            <section className="py-16 md:py-24 px-4 md:px-6 relative z-10 border-t border-white/5 overflow-clip">
                {/* Ambient effects */}
                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 mb-10 md:mb-14">
                        <div className="lg:col-span-5">
                            <ScrollReveal>
                                ...
                                <h2 className="font-heading font-bold text-3xl md:text-4xl lg:text-5xl text-white uppercase tracking-tight leading-[0.95] mb-4">
                                    Common<br />
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-3 md:gap-4 mb-14 md:mb-20">
                        {faqItems.map((item, i) => (
                            ...
                            <div className="relative border border-white/[0.08] bg-zinc-900/30 backdrop-blur-xl rounded-2xl overflow-hidden">
                                ...
                                <div className="px-6 py-16 md:px-12 md:py-20 text-center relative">
                                    <div className="max-w-2xl mx-auto">
                                        ...
                                        <h2 className="font-heading font-bold text-3xl md:text-4xl lg:text-5xl text-white uppercase tracking-tight mb-5 leading-[0.95]">
                                            Ready to Deploy<br />
