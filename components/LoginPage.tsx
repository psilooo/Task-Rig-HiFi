      ...
      <div className="w-full max-w-md px-4 relative z-10">
        <Reveal>
          <div className="text-center mb-12">
            ...
            <button onClick={onBack} className="inline-block hover:scale-105 transition-transform group">
              <h1 className="font-heading font-bold text-5xl md:text-6xl text-white tracking-tighter leading-none mb-2 group-hover:text-orange-500 transition-colors">
                TASK RIG
              </h1>
            </button>
