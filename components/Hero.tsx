    ...
    return (
        <section className="relative min-h-[100svh] flex flex-col bg-zinc-950 overflow-clip">
            ...
            <div className="absolute inset-0 pointer-events-none z-0">
                ...
                <div className="hidden md:flex absolute inset-0 items-center justify-center scale-[1.2] origin-center mix-blend-screen opacity-80 -mt-2 mr-6">
                    <DotMatrixLogo />
                </div>
            ...
            <div className="flex-1 flex items-start pt-4 md:items-center justify-center relative z-20 w-full max-w-7xl mx-auto px-4 md:px-8 py-12">
                ...
                <div className="w-full relative z-20 flex justify-center">
                    ...
                    <div className="relative flex flex-col items-center text-center w-full max-w-4xl shrink-0 md:mt-10">
